...
class TechniquesAgricoleController extends Controller
{
    ...
    {
        $actions = [
            new Action(ucwords('Ajouter nouveau'), Action::TYPE_NORMAL, route('TechniquesAgricole.create')),
            new Action(ucwords('supprimer les selctionner'), Action::TYPE_DELETE_ALL ,  route('TechniquesAgricole.destroyGroup')),
        ];
        $heads = [
    ...
    public function show(Request $request, $id)
    {
        ...
        $data = [
            ...
            'ModesTechniques' =>[
                    ...
                    'actions' => [
                        new Action(ucwords('Ajouter nouveau'), Action::TYPE_NORMAL, url: route('ModesTechnique.create' , ['idTA' => $model[ModelTarget::PK]])),
                        new Action(ucwords('supprimer les selctionner'), Action::TYPE_DELETE_ALL , url: route('ModesTechnique.destroyGroup')),
                    ] ,
                    'heads' => [
            ...
            'Qualifications' => [
                    ...
                    'actions' => [
                        new Action(ucwords('Ajouter nouveau'), Action::TYPE_NORMAL, url: route('qualifications.create' ,['idTA' => $model[ModelTarget::PK]])),
                        new Action(ucwords('supprimer les selctionner'), Action::TYPE_DELETE_ALL , url: route('qualifications.destroyGroup')),
                    ] ,
                    'heads' => [
                        new Head('logo', Head::TYPE_IMG, 'Logo'),
                        new Head('titre', Head::TYPE_TEXT,'Titre' ),
                        new Head('unite', Head::TYPE_TEXT,'Unite' ),
                        new Head('description', Head::TYPE_TEXT,'Description' ),
                    ],
            ...
            'typeMateriel' => [
                    ...
                    'actions' => [
                        new Action(ucwords('Ajouter nouveau'), Action::TYPE_NORMAL, url: route('typeMateriel.create', ['idTA' => $model[ModelTarget::PK]])),
                        new Action(ucwords('supprimer les selctionner'), Action::TYPE_DELETE_ALL , url: route('typeMateriel.destroyGroup')),
                    ] ,
                    'heads' => [
                ...
                'techniquesSpecifiques' => [
                        ...
                        'actions' => [
                            new Action(ucwords('Ajouter nouveau'), Action::TYPE_NORMAL, url: route('TechniqueSpecifique.create' ,['idTA' => $model[ModelTarget::PK]])),
