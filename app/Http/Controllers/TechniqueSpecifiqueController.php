...
class TechniqueSpecifiqueController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $actions = [
            new Action(ucwords('Ajouter nouveau'), Action::TYPE_NORMAL, url: route('ChargesTechSpe.create' , [
                // 'id_espece' => $model[ModelTarget::PK],
                'id_tech' => $model[ModelTarget::PK],
                
            ])),
            new Action(ucwords('supprimer les selctionner'), Action::TYPE_DELETE_ALL, url: route('ChargesTechSpe.destroyGroup'))
        ];
        $heads = [
            
            new Head('titre' , Head::TYPE_TEXT, "Titre"),
            new Head('costUnit' , Head::TYPE_TEXT, "Cost Unit"),
