    ...
    >
        ...
        <x-form.card col="col-12 row" title="Identifiant Ferme">
            ...
            <div class="col-md-10 row">
                ...
                <x-form.input type='number' step="0.01" min='0' col="col-12 col-md-6" name="SAT" label="Superficie Agricole Totale" />
                <x-form.input type='number' step="0.01" min='0' col="col-12 col-md-6" name="SAU" label="Superficie Agricole Utile" />
