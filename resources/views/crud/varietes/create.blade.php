...
@section('content')
    ...
    >
        <x-form.card col="col-12 row" title="Entrer les Informations des Varietes">
            
         
            <x-form.input required  name="nomCommercial" col="col-12 col-md-6" label="nom Commercial"/>
            <x-form.input required  name="appelationAr" col="col-12 col-md-6" label="appelation Arabe"/>
            <x-form.input required col="col-12 col-md-4" name="quantite" label="qualite"/>
