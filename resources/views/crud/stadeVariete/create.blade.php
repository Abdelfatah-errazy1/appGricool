...
@section('breadcrumb')
    ...
    :indexes="[
        ['name'=> 'retour' , 'route'=> route('varietes.show',$varieteId)],
        ['name' => 'Ajouter un Variete Stade', 'current' => true],
    ]"
...
@section('content')
    ...
    <x-form.form method="post" action="{{ route('stadeVarietes.store') }}">
            <x-form.card col="col-12 row" title='Entrer les informations de Stade Variete'>
