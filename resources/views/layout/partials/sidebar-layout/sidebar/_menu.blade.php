	...
	<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
		...
		<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true"
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				...
				<span class="menu-link">
					<span class="menu-icon"><img src="{{ asset('assets/imgs/ferme.png') }}" width="20" alt=""></span>
				...
				<div class="menu-sub menu-sub-accordion">
					...
					<div class="menu-item">
						...
						<a class="menu-link" href="{{ route('fermes.create') }}">
							...
							<span class="menu-title">Ajouter nouveau </span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
		...
		<!--begin:Menu item-->
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				<!--begin:Menu link-->
				<span class="menu-link">
					<span class="menu-icon"><img src="{{ asset('assets/imgs/plant.png') }}" width="20" alt=""></span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				<!--begin:Menu link-->
				<span class="menu-link">
					<span class="menu-icon"><img src="{{ asset('assets/imgs/land.png') }}" width="20" alt=""></span>
				...
				<div class="menu-sub menu-sub-accordion">
					...
					<div class="menu-item">
						...
						<a class="menu-link" href="{{ route('cultureparcelle.create') }}">
							...
							<span class="menu-title">Ajouter nouveau culture </span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
				...
				<!--end:Menu sub-->
					...
					<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
						<!--begin:Menu link-->
						<span class="menu-link">
							<span class="menu-icon"><img src="{{ asset('assets/imgs/speed.png') }}" width="20" alt=""></span>
						...
						<div class="menu-sub menu-sub-accordion">
								...
								<div class="menu-item">
									...
									<a class="menu-link" href="{{ route('TechniquesAgricole.create') }}">
										...
										<span class="menu-title">Ajouter Technique </span>
									</a>
									<!--end:Menu link-->
								</div>
					<!--end:Menu item-->
