...
use App\Http\Controllers\ExecutionTechniqueController;
...
Route::post('/chart/filter', [\App\Http\Controllers\ChartController::class , 'filter'])->name('chart.filter');


Route::group(['prefix' => 'executionTechnique'], function () {
    Route::post('charge-table', [ExecutionTechniqueController::class , 'chargeTable'])->name('charge.table');
    Route::post('get-data', [ExecutionTechniqueController::class , 'getData'])->name('getData');
    Route::post('save-execution-technique', [ExecutionTechniqueController::class , 'store'])->name('store.ExecutionTechnique');
    Route::get('delete/{id}', [ExecutionTechniqueController::class, 'delete'])->name('delete.Execution');
    Route::get('ajoute-Charge/{id}', [ExecutionTechniqueController::class, 'ajouteCharge'])->name('ajoute.Charge');
    Route::post('store', [ExecutionTechniqueController::class, 'chargeExecStore'])->name('chargeExec.store');

    Route::get('{id}/deleteCharge', [ExecutionTechniqueController::class, 'deleteCharge'])->name('deleteCharge');
});

Route::get('/', [DashboardController::class,'plantation'])->name('dashboard');
Route::prefix('/')->name('dashboard.')->group(function () {
    Route::post('get-Unite', [DashboardController::class, 'getUnite'])->name('getUnite');
    Route::post('/storem', [DashboardController::class, 'store'])->name('store');
    Route::post('/storeTS', [DashboardController::class, 'storeTS'])->name('storeTS');
